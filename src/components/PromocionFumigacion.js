    ...
    <div className="bg-gradient-to-r from-green-400 via-green-500 to-green-600 text-white p-8 rounded-lg shadow-lg max-w-4xl mx-auto my-12">
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="flex-shrink-0 text-center md:text-left">
          ...
          <a href="tel:+3014894440" className="text-2xl font-bold text-yellow-300 hover:underline">
            +57 3014894440
          </a>
          <a href="tel:+3014894440" className="mt-4 inline-block bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-full">
            Contáctanos Ahora
          </a>
        </div>
      </div>
